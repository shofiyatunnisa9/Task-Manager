...
import { loginSchema, LoginSchemaDTO, registerSchema, RegisterSchemaDTO } from "@/schemas/authSchema";
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-900/70 border border-gray-200 dark:border-gray-800 rounded-xl shadow-xl p-8">
          <div className="text-center mb-6">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2">Welcome</h1>
            <p className="text-gray-600 dark:text-gray-300">Register to manage your tasks</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 text-gray-700 dark:text-gray-200">
            ...
            {registerForm.isError && (
              <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4">
                <p className="text-sm font-semibold text-red-800 dark:text-red-200 mb-1">Login failed</p>
            ...
            >
              {registerForm.isPending ? "Logging in..." : "Register"}
            </button>
